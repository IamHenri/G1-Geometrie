<?php  include 'entete.php';?> <p class="a rotatedFloralHeartBullet">
    <!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
</p>
<p>
<h1>Accueil et index </h1>
</p>
<p>
...
<ul>
    ...
    <li><a href="chapitre-2-les-coordonnees-cartesiennes.php">Les coordonnées cartésiennes</a></li>
    <li><a href="chapitre-3-les-coordonnees-polaires.php">Les coordonnées polaires</a></li>
    <li><a href="chapitre-4-les-coordonnees-dans-l-espace.php">Les coordonnées dans l'espace</a></li>
    <li><a href="chapitre-5-les-coordonnees-cylindriques.php">Les coordonnées cylindriques</a></li>
...
<ul>
    ...
    <li><a href="chapitre-7.4-les-vecteurs-produit-scalaire-et-comparaison-des-vecteurs.php">Le produit scalaire</a></li>
    <li><a href="chapitre-7.5-les-vecteurs-Relation-AL-Kashi-Mediane-formule-cosinus-et-sinus.php">Al-Kashi ou la formule du cosinus (et du sinus)</a></li>
    <li><a href="chapitre-7.6-les-vecteurs-lieux-geometriques.php">Lieux géométriques</a></li>
    <li><a href="chapitre-7.7-les-vecteurs-TLDR.php">Les vecteurs : TL;DR</a></li>
</ul>
<!--  <li><a href="chapitre-8.5-element-de-geometrie-distance-point-plan.php">Distance d'un point à un plan</a></li>
      <li><a href="chapitre-8.6-element-de-geometrie-projection-orthogonale-sur-un-plan.php">Projection orthogonlae sur un plan</a></li>
      <li><a href="chapitre-8.7-element-de-geometrie-definir-droites-vecteurs-segments.php">Construire des droites, segments</a></li> -->
<h3>Quelques pages sur les barycentres</h3>
<ul>
    <li><a href="chapitre-9-les-barycentres-et-polynomes-de-bernstein-chapitre1.php">Première approche et formules</a></li>
    <li><a href="chapitre-9-les-barycentres-et-polynomes-de-bernstein-chapitre2.php">Théorie</a></li>
    <li><a href="chapitre-9-les-barycentres-et-polynomes-de-bernstein-chapitre3.php">Applications</a></li>
    <li><a href="chapitre-9-les-barycentres-et-polynomes-de-bernstein-chapitre4.php">Barycentres mouvants et introduction aux polynômes de Bernstein</a></li>
    <li><a href="chapitre-9-les-barycentres-et-polynomes-de-bernstein-chapitre5.php">Exercices corrigés</a></li>
</ul>
<br>
</p>
<p>
<h3>Quelques pages sur des sujets unitaires</h3>
<ul>
...
<p>
<h3>Quelques éléments de géométrie</h3>
<ul>
...
<ul>
    <li><a href="analyse-vectorielle/analyse-vectorielle-chap01.php">Premières définition et champ d'application de l'analyse vectorielle</a></li>
    <li><a href="analyse-vectorielle/analyse-vectorielle-chap02.php">Premières définition et champ d'application de l'analyse vectorielle</a></li>
    <li><a href="analyse-vectorielle/analyse-vectorielle-chap03.php">Les opérateurs de l'analyse vectorielle</a></li>
    <li><a href="analyse-vectorielle/analyse-vectorielle-chap04.php">Les champs scalaires et vectoriels</a></li>
    <li><a href="analyse-vectorielle/analyse-vectorielle-chap05.php">L'opérateur Nabla</a></li>
...
<ul>
    <li><a href="une-autre-methode-de-multiplication.php">Une méthode puissante de multiplication</a></li>
</ul>
</p>
<br>
<hr>
<a href="Prologue.php">Page suivante &rarr;</a><br>
<a href="chapitre-1-contexte-mathematiques-repere.php">Zapper le prologue &rarr;</a><br> <?php  include 'pieddepage.php';?>